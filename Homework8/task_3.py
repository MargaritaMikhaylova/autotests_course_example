...
def segment(*coord):
    '''
    Функция принимает на вход два кортежа с координатами точек (x1, y1), (x2, y2) и возвращает сумму всех координат
    :param coord: Два кортежа с координатами точек (x1, y1), (x2, y2)
    :return: Сумма всех координат. В случае исключения функция возвращает текст исключения задом наперед
    '''
    try:
        segment = coord[0][0] + coord[0][1] + coord[1][0] + coord[1][1]
        return segment
