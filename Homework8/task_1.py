...
def treatment_sum(our_tuple):
    '''
    Функция суммирует два элемента поступившего на вход кортежа. Либо обрабатывает исключение
    :param our_tuple: кортеж
    :return: сумма двух элементов кортежа. Либо сообщение об ошибке, если в кортеже не два элемента или их
    нельзя суммировать
    '''
    if len(our_tuple) > 2:
