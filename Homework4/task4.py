...
def multiplication_chain(num):
    '''
    функция принимает положительное число и возвращает количество раз count_multy, 
    которое вы должны перемножить цифры числа num и полученных произведений, пока не получите одну цифру.
    :param num: положительное число
    :return: конечное произведение цифр числа
    ''''''
    count_multy = 0
    symbols = str(num)
    while len(symbols) > 1:
